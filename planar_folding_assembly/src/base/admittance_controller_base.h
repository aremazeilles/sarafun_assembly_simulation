...
void AdmittanceControllerBase::controllerLoad( physics::ModelPtr model, sdf::ElementPtr sdf )
{
...
void AdmittanceControllerBase::controllerUpdate( const common::UpdateInfo info )
{
